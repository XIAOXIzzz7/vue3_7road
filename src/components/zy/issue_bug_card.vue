                ...
                <div>
                  <h5 :style="h5_stytle">{{num}} 个
                    <span class="badge"  v-if="button" @click="openModal()">
                          <el-button style="padding:12px"  @click="dialogTableVisible = true" >
...
import {hgaxios} from "../../utils/request"
// import axios from 'axios';
// import $ from 'jquery'
...
export default {
    ...
    methods: {
        openModal(){
            ...
            hgaxios.post("/api/v1/DataTable/",{type:this.$props.table_type, start:this.$props.start, end:this.$props.end, projects: project_list,iteration:table_dict.iteration,page:this.page,page_size:this.page_size,search:this.input,fields:["id","title","severity","reporter","created","closed","status", "url"]})
            .then(res => {
                console.log(res)
