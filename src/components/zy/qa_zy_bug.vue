...
<div class="master">
    <div >
        <div style="margin-left:10px">
            <h5 style="text-align:left;font-size:18px;font-weight:bolder">质控 自研项目BUG列表</h5>
        </div>
        <hr>
   ...
   <div style="display:flex">
    ...
    <el-table-column label="标题" min-width="300">
         <template v-slot="scope">
            <span style="text-align:left;padding:5px;font-size:14px;margin:8px 0px 8px 0px;font-weight: normal;min-height:50px">{{scope.row.title}}</span>
        </template>
    </el-table-column>
             ...
             axios({
              ...
              params:{
                ...
                //  res.data.data.projects
                  hpaxios("/api/v1/DataTable/",{type:"bug",data_type:"zy",projects:res.data.data.projects,iteration:"所有迭代",page:this.apipage,page_size:this.apipage_size,search:this.input,fields:["id","priority","title","severity","reporter","created","closed","status", "url"] })
                    .then(res => {
