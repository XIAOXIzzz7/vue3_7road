...
<el-tabs
    ...
    style="margin:20px"
  >
    <el-tab-pane label="渠道测试需求" name="first">
            ...
            <div style="display:flex;">
              <el-card class="box-card" style="flex:0 0 100%">
                ...
                <div style="display:flex;flex-direction: column;float: left;">
                    ...
                    <div style="margin-left:9px;float:left;margin-bottom: 20px;">
                        <el-input style="width: 777px;float:left;" v-model="data_set.projectinput1" placeholder="请输入标题">
    ...
    <el-tab-pane label="SDK服务端更新" name="second">
      <el-button @click="check()">11</el-button>
        <div class="content">
          <div style="margin: 20px;">
            <div style="display:flex;">
    ...
    <el-tab-pane label="客户端性能测试" name="third">
      <el-button @click="check()">11</el-button>
        <div class="content">
          <div style="margin: 20px;">
            <div style="display:flex;">
    ...
    <el-tab-pane label="项目测试阶段报告" name="fourth">
      <el-button @click="check()">11</el-button>
        <div class="content">
          <div style="margin: 20px;">
            <div style="display:flex;">
  ...
  <script lang="ts" setup>
    ...
    const handleClick = (tab: TabsPaneContext, event: Event) => {
      if(tab.props.label=="渠道测试需求"){
        data_set.editorData = data_set.test_issue
        data_set.nowdata = 'data_set.test_issue'
      }
      else if(tab.props.label=="SDK服务端更新"){
        data_set.editorData = data_set.SDK
        data_set.nowdata = data_set.SDK
      }
      else if(tab.props.label=="客户端性能测试"){
        data_set.editorData = data_set.performance
        data_set.nowdata = data_set.performance
      }
      else if(tab.props.label=="项目测试阶段报告"){
        data_set.editorData = data_set.stage
        data_set.nowdata = data_set.stage
      }
      // onMounted(()=>{
      //   if(tab.props.label=="渠道测试需求"){
      //   data_set.editorData = data_set.test_issue
      //   data_set.nowdata = 'data_set.test_issue'
      //   }
      //   else if(tab.props.label=="tst2"){
      //     data_set.editorData = data_set.test2
      //     data_set.nowdata = data_set.test2
      //   }
      //   })
    ...
    const data_set = reactive(
      {
        textData:"",
        SDK:`<p>Dear all,</p><p><span style="background-color:rgb(255,255,255);color:rgb(51,102,255);">一、服务端更新内容</span></p><p>&nbsp;</p><p><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">二、 影响程度：</span></p><p>&nbsp;</p><p><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">三、 影响的游戏:&nbsp;&nbsp;</span></p><p>&nbsp;</p><p><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">四、更新时间：</span></p><p>&nbsp;</p><p><span style="color:#ff0000;">&nbsp; &nbsp; &nbsp; &nbsp; 请运营同学确认后回复！</span><br><br><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">&nbsp; &nbsp; &nbsp; &nbsp; 以上，如有问题请及时反馈，谢谢！</span></p><p><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</span>胡俊</p><p>&nbsp; &nbsp; &nbsp; &nbsp; 深圳第七大道科技有限公司&nbsp;&nbsp;&nbsp;&nbsp;技术中心</p><p>&nbsp; &nbsp; &nbsp; &nbsp; Mob:&nbsp;+86&nbsp;13524778793</p><p><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</span><a href="mailto:jun.hu@7road.com"><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">mailto:jun.hu@7road.com</span></a></p><p><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">&nbsp; &nbsp; &nbsp; &nbsp; Add：上海市闵行区合川路3111号2号楼7楼</span></p>`,
        stage:`<p><span style="font-size:30px;"><strong>Dear all,</strong></span></p><p>&nbsp;</p><p>&nbsp;</p><p><span style="background-color:hsl(240,75%,60%);color:hsl(0,0%,100%);font-size:21px;"><strong>一、S6阶段测试情况：</strong></span></p><p>&nbsp;</p><p>&nbsp;</p><p><span style="background-color:hsl(240,75%,60%);color:hsl(0,0%,100%);font-size:21px;"><strong>二、版本控制风险：</strong></span></p><p>&nbsp;</p><p><span style="background-color:hsl(240,75%,60%);color:hsl(0,0%,100%);font-size:21px;"><strong>三、测试详情：</strong></span></p><figure class="table" style="float:left;width:100%;"><table style="background-color:rgb(255, 255, 255);"><tbody><tr><td style="border-bottom-style:none;border-left:1pt solid rgb(189, 215, 238);border-right-style:none;border-top:1pt solid rgb(189, 215, 238);height:20.25pt;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:703pt;" colspan="5">功能专项验收详情如下：</td></tr><tr><td style="background-color:rgb(149, 179, 215);border-bottom:0.5pt solid windowtext;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;height:16.5pt;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:162pt;"><strong>测试类型</strong></td><td style="background-color:rgb(149, 179, 215);border-bottom-style:none;border-left:0.5pt solid windowtext;border-right:0.5pt solid windowtext;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:162pt;"><strong>当前状况</strong></td><td style="background-color:rgb(149, 179, 215);border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top-style:none;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:185pt;"><strong>问题详情</strong></td><td style="background-color:rgb(149, 179, 215);border-bottom-style:none;border-left:0.5pt solid windowtext;border-right:0.5pt solid windowtext;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:54pt;"><strong>质量风险</strong></td><td style="background-color:rgb(252, 228, 214);border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:140pt;"><i><strong>S6评估标准</strong></i></td></tr><tr><td style="border:0.5pt solid windowtext;height:177.75pt;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:162pt;">游戏功能</td><td style="border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:162pt;">&nbsp;</td><td style="border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:185pt;">&nbsp;</td><td style="border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;">&nbsp;</td><td style="border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:140pt;" rowspan="5"><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">功能测试结果所有S级、A级bug必须修复，遗留未处理的B级bug占比不高于10%</span></td></tr><tr><td style="border:0.5pt solid windowtext;height:33pt;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:162pt;">中断测试</td><td style="border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:162pt;">&nbsp;</td><td style="border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:185pt;">&nbsp;</td><td style="border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;">&nbsp;</td></tr><tr><td style="border:0.5pt solid windowtext;height:33.6pt;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:162pt;">画质测试</td><td style="border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:162pt;">&nbsp;</td><td style="border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:185pt;">&nbsp;</td><td style="border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;">&nbsp;</td></tr><tr><td style="border:0.5pt solid windowtext;height:24.95pt;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:162pt;">覆盖安装测试</td><td style="border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:162pt;">&nbsp;</td><td style="border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:185pt;">&nbsp;</td><td style="border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;">&nbsp;</td></tr><tr><td style="border:0.5pt solid windowtext;height:36pt;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:162pt;">热更新测试</td><td style="border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:162pt;">&nbsp;</td><td style="border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:185pt;">&nbsp;</td><td style="border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;">&nbsp;</td></tr></tbody></table></figure><figure class="table" style="float:left;width:100%;"><table style="background-color:rgb(255, 255, 255);"><tbody><tr><td style="border-bottom:0.5pt solid windowtext;border-left:0.5pt solid windowtext;border-right-color:initial;border-right-style:none;border-top:0.5pt solid windowtext;height:16.5pt;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:1169pt;" colspan="5">2、其他技术专项验收情况如下：</td></tr><tr><td style="background-color:rgb(149, 179, 215);border-bottom:0.5pt solid windowtext;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;height:15pt;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:122pt;"><strong>测试类型</strong></td><td style="background-color:rgb(149, 179, 215);border-bottom:0.5pt solid windowtext;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:572pt;"><strong>当前状况</strong></td><td style="background-color:rgb(149, 179, 215);border-bottom:0.5pt solid windowtext;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:221pt;"><strong>主要问题&amp;建议</strong></td><td style="background-color:rgb(149, 179, 215);border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:54pt;"><strong>质量风险</strong></td><td style="background-color:rgb(252, 228, 214);border:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:200pt;"><i><strong>S6估标准</strong></i></td></tr><tr><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;height:391.5pt;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:122pt;">前端性能</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:572pt;">&nbsp;</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:221pt;">&nbsp;</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right:0.5pt solid windowtext;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:54pt;">&nbsp;</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right:0.5pt solid windowtext;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:200pt;">Ø最高 PSS（Android）：<br>1 档机&lt;=1600M;<br>2 档机&lt;=1400M;<br>3 档机&lt;=1200M<br>最高 PSS（iOS）：<br>1 档机&lt;=1200M;<br>2 档机&lt;=1000M;<br>3档机&lt;=900M<br>Ø.CPU 使用率小于 60%占比（Android）：&gt;90%<br>CPU 使用率小于 80%占比（iOS）：&gt;90%;<br><br>Ø.85%FPS（Android）:<br>1 档机&gt;=25;<br>2 档机&gt;=25;<br>3档机&gt;=18；<br>90%FPS（iOS）:<br>1 档机&gt;=25;<br>2 档机&gt;=25;<br>3 档机&gt;=18</td></tr><tr><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;height:115.5pt;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:122pt;">兼容性</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:572pt;">&nbsp;</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:221pt;">&nbsp;</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right:0.5pt solid windowtext;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;">&nbsp;</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right:0.5pt solid windowtext;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:200pt;"><p><span style="background-color:transparent;">1.第三方机型兼容通过率需达标&gt;=95%</span></p><p>2.Android&amp;iOS 市场<br>占有率 Top10 机型全部通过测试&amp;不得有 S、A 级兼容 bug</p></td></tr><tr><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;height:99pt;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:122pt;">弱网</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:572pt;">&nbsp;</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:221pt;">&nbsp;</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right:0.5pt solid windowtext;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;">&nbsp;</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right:0.5pt solid windowtext;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:200pt;">在游戏设计支持的最大网络延迟、丢包率（不同游戏类型对弱网要求不同）、抖动的场景下，需对延时的有合理的提示</td></tr><tr><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;height:105.75pt;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:122pt;">压力测试</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:572pt;">&nbsp;</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:221pt;">&nbsp;</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right:0.5pt solid windowtext;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;">&nbsp;</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right:0.5pt solid windowtext;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:200pt;"><p>承载、业务逻辑、稳定性压测</p><p>１.核心场景性能基线需达标：各事务95%响应时间&lt;800ms<br>２.综合场景稳定性测试：机器人无掉线，服务进程无Crash，无内存泄漏，运行24小时以上后各事务成功率&gt;99.9%，各节点负载要实现均衡<br><br>容错测试<br>１.被拉起节点或进程负载不能存在异常，玩家游戏数据尽可能少丢失，丢失数据时长不超过3分钟<br><br>动态扩容<br>1.分布式部署的服务进程需满足不停服新增节点服务器，新增节点加入后符合原先的负载均衡算法且新登录的用户流量会平滑的分流到新扩容的服务上<br><br>排队系统<br>在S5开新服阶段为预防出现爆发性新用户涌入及登录，需要设计并测试排队系统，控制用户流量，维护游戏服务正常运行，保障玩家游戏体验<br><br>容灾测试<br>项目组必须有容灾计划，在发生设备故障、网络故障等灾难，在保证玩家数据尽可能少丢失的前提下，尽快恢复正常服务<br>&nbsp;</p></td></tr><tr><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;height:162pt;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;width:122pt;" rowspan="5">容错测试</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:572pt;" rowspan="5">&nbsp;</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right-style:none;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:221pt;" rowspan="5">&nbsp;</td><td style="border-bottom-style:none;border-left:0.5pt solid windowtext;border-right:0.5pt solid windowtext;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;text-align:center;" rowspan="5">&nbsp;</td><td style="border-bottom-color:initial;border-bottom-style:none;border-left:0.5pt solid windowtext;border-right:0.5pt solid windowtext;border-top:0.5pt solid windowtext;padding-left:1px;padding-right:1px;padding-top:1px;width:200pt;">1.在大压力下根据具体用例杀死相关服务进程，测试被杀进程是否可自动拉起</td></tr><tr><td style="border-bottom-color:initial;border-bottom-style:none;border-left:0.5pt solid windowtext;border-right:0.5pt solid windowtext;border-top-color:initial;border-top-style:none;height:14.25pt;padding-left:1px;padding-right:1px;padding-top:1px;width:200pt;">&nbsp;</td></tr><tr><td style="border-bottom-color:initial;border-bottom-style:none;border-left:0.5pt solid windowtext;border-right:0.5pt solid windowtext;border-top-color:initial;border-top-style:none;height:41.25pt;padding-left:1px;padding-right:1px;padding-top:1px;width:200pt;">2.拉起后是不能存在因为进程启动的异常顺序等原因引发的逻辑错误等问题</td></tr><tr><td style="border-bottom-color:initial;border-bottom-style:none;border-left:0.5pt solid windowtext;border-right:0.5pt solid windowtext;border-top-color:initial;border-top-style:none;height:14.25pt;padding-left:1px;padding-right:1px;padding-top:1px;width:200pt;">&nbsp;</td></tr><tr><td style="border-bottom:0.5pt solid windowtext;border-left:0.5pt solid windowtext;border-right:0.5pt solid windowtext;border-top-color:initial;border-top-style:none;height:51pt;padding-left:1px;padding-right:1px;padding-top:1px;width:200pt;">3.被拉起节点或进程负载不能存在异常，玩家游戏数据尽可能少丢失，丢失数据时长不超过 5 分钟</td></tr></tbody></table></figure><p>&nbsp;</p><figure class="table"><table style="border:1px solid hsl(0, 0%, 100%);"><tbody><tr><td style="border:1px solid hsl(0, 0%, 100%);"><p><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">以上，有劳查阅，如有疑问，请随时联系，谢谢！</span></p><p>胡俊</p><p>深圳第七大道科技有限公司&nbsp;&nbsp;&nbsp;&nbsp;技术中心</p><p>Mob:&nbsp;+86&nbsp;13524778793</p><p><a href="mailto:jun.hu@7road.com"><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">mailto:jun.hu@7road.com</span></a></p><p><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">Add：上海市闵行区合川路3111号2号楼7楼</span></p></td></tr></tbody></table></figure>`,
        performance:`<p><strong>DEAR ALL</strong></p><p>&nbsp;</p><p><strong>PS：注意事项</strong></p><p>&nbsp;</p><figure class="table" style="float:left;width:100%;"><table class="ck-table-resized"><colgroup><col style="width:13.31%;"><col style="width:11.41%;"><col style="width:7.46%;"><col style="width:11.46%;"><col style="width:8.74%;"><col style="width:11.12%;"><col style="width:14.07%;"><col style="width:22.43%;"></colgroup><tbody><tr><td style="background-color:hsl(30, 75%, 60%);padding:10px;text-align:center;" colspan="8"><span style="font-size:21px;"><strong>客户端性能测试报告</strong></span></td></tr><tr><td style="padding:50px;text-align:center;"><strong>测试结论</strong></td><td style="padding:10px;" colspan="7">&nbsp;</td></tr><tr><td style="text-align:center;"><strong>问题总结</strong></td><td style="height:500px;padding:10px;" colspan="7">&nbsp;</td></tr><tr><td style="background-color:hsl(30, 75%, 60%);text-align:center;" colspan="8"><span style="font-size:21px;"><strong>测试环境</strong></span></td></tr><tr><td style="padding:10px;text-align:center;"><strong>游戏名称</strong></td><td>&nbsp;</td><td style="padding:10px;text-align:center;"><strong>测试阶段</strong></td><td>&nbsp;</td><td style="padding:10px;text-align:center;"><strong>客户端版本号</strong></td><td>&nbsp;</td><td style="padding:10px;text-align:center;"><strong>数据共享地址（高端机）</strong></td><td>&nbsp;</td></tr><tr><td style="padding:10px;text-align:center;"><strong>测试类型</strong></td><td>&nbsp;</td><td style="padding:10px;text-align:center;"><strong>测试标准</strong></td><td>&nbsp;</td><td style="padding:10px;text-align:center;" rowspan="2"><strong>测试机型</strong></td><td rowspan="2">&nbsp;</td><td style="padding:10px;text-align:center;"><strong>数据共享地址（中端机）</strong></td><td>&nbsp;</td></tr><tr><td style="padding:10px;text-align:center;"><strong>测试日期</strong></td><td>&nbsp;</td><td style="padding:10px;text-align:center;"><strong>测试工具</strong></td><td>&nbsp;</td><td style="padding:10px;text-align:center;"><strong>数据共享地址（低端机）</strong></td><td>&nbsp;</td></tr><tr><td style="padding:10px;text-align:center;"><strong>测试屈服</strong></td><td>&nbsp;</td><td style="padding:10px;text-align:center;"><strong>测试网络</strong></td><td>&nbsp;</td><td style="padding:10px;text-align:center;"><strong>MD5码</strong></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr></tbody></table></figure><figure class="table" style="float:left;width:100%;"><table class="ck-table-resized"><colgroup><col style="width:19.24%;"><col style="width:4.17%;"><col style="width:11.08%;"><col style="width:10.47%;"><col style="width:3.92%;"><col style="width:10.61%;"><col style="width:11.25%;"><col style="width:4.24%;"><col style="width:10.69%;"><col style="width:10.56%;"><col style="width:3.77%;"></colgroup><tbody><tr><td style="background-color:hsl(30, 75%, 60%);padding:10px;text-align:center;"><span style="font-size:21px;"><strong>测试机型详情</strong></span></td><td>&nbsp;</td><td style="background-color:hsl(30, 75%, 60%);text-align:center;" colspan="2">&nbsp;</td><td style="background-color:hsl(0, 0%, 100%);">&nbsp;</td><td style="background-color:hsl(30, 75%, 60%);text-align:center;" colspan="2">&nbsp;</td><td>&nbsp;</td><td style="background-color:hsl(30, 75%, 60%);text-align:center;" colspan="2">&nbsp;</td><td>&nbsp;</td></tr><tr><td style="padding:10px;" rowspan="7">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;"><strong>info</strong></td><td style="padding:10px;"><strong>value</strong></td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;"><strong>info</strong></td><td style="padding:10px;"><strong>value</strong></td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;"><strong>info</strong></td><td style="padding:10px;"><strong>value</strong></td><td style="padding:10px;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">OS</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">OS</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">OS</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">CPU</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">CPU</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">CPU</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">GPU</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">GPU</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">GPU</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">Resolution</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">Resolution</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">Resolution</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">Screen Size</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">Screen Size</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">Screen Size</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">Ram Size</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">Ram Size</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">Ram Size</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td></tr><tr><td colspan="11">&nbsp;</td></tr></tbody></table></figure><figure class="table" style="float:left;width:100%;"><table class="ck-table-resized"><colgroup><col style="width:11.58%;"><col style="width:4.31%;"><col style="width:6.44%;"><col style="width:7.26%;"><col style="width:7.52%;"><col style="width:3.79%;"><col style="width:6.62%;"><col style="width:7.01%;"><col style="width:7.97%;"><col style="width:3.92%;"><col style="width:33.58%;"></colgroup><tbody><tr><td style="background-color:hsl(30, 75%, 60%);text-align:center;"><span style="font-size:21px;"><strong>FPS</strong></span></td><td>&nbsp;</td><td style="background-color:hsl(30, 75%, 60%);text-align:center;" colspan="3"><strong>fps大于标准帧比率</strong></td><td style="background-color:hsl(0, 0%, 100%);text-align:center;">&nbsp;</td><td style="background-color:hsl(30, 75%, 60%);text-align:center;" colspan="3"><strong>平均FPS</strong></td><td style="background-color:hsl(0, 0%, 100%);text-align:center;">&nbsp;</td><td style="background-color:hsl(30, 75%, 60%);text-align:center;"><strong>备注</strong></td></tr><tr><td style="padding:10px;"><strong>机型</strong></td><td>&nbsp;</td><td style="padding:10px;text-align:center;"><strong>实际测试</strong></td><td style="padding:10px;text-align:center;"><strong>S6阶段标准</strong></td><td style="padding:10px;text-align:center;"><strong>是否通过</strong></td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;"><strong>实际结果</strong></td><td style="padding:10px;text-align:center;"><strong>S6阶段标准</strong></td><td style="padding:10px;text-align:center;"><strong>是否通过</strong></td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td></tr><tr><td style="padding:10px;text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td>&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td></tr></tbody></table></figure><figure class="table" style="float:left;width:100%;"><table class="ck-table-resized"><colgroup><col style="width:11.43%;"><col style="width:4.49%;"><col style="width:6.29%;"><col style="width:7.33%;"><col style="width:7.59%;"><col style="width:3.79%;"><col style="width:59.08%;"></colgroup><tbody><tr><td style="background-color:hsl(30, 75%, 60%);text-align:center;"><span style="font-size:21px;"><strong>CPU</strong></span></td><td>&nbsp;</td><td style="background-color:hsl(30, 75%, 60%);text-align:center;" colspan="3"><strong>cpu低于%比率</strong></td><td style="background-color:hsl(0, 0%, 100%);text-align:center;">&nbsp;</td><td style="background-color:hsl(30, 75%, 60%);text-align:center;"><strong>备注</strong></td></tr><tr><td style="padding:10px;"><strong>机型</strong></td><td>&nbsp;</td><td style="padding:10px;text-align:center;"><strong>实际测试</strong></td><td style="padding:10px;text-align:center;"><strong>S6阶段标准</strong></td><td style="padding:10px;text-align:center;"><strong>是否通过</strong></td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td><td style="text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td>&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td></tr></tbody></table></figure><figure class="table" style="float:left;width:100%;"><table class="ck-table-resized"><colgroup><col style="width:11.37%;"><col style="width:4.62%;"><col style="width:6.42%;"><col style="width:7.16%;"><col style="width:7.58%;"><col style="width:3.79%;"><col style="width:59.06%;"></colgroup><tbody><tr><td style="background-color:hsl(30, 75%, 60%);text-align:center;"><span style="font-size:21px;"><strong>内存</strong></span></td><td>&nbsp;</td><td style="background-color:hsl(30, 75%, 60%);text-align:center;" colspan="3"><strong>pss内存峰值</strong></td><td style="background-color:hsl(0, 0%, 100%);text-align:center;">&nbsp;</td><td style="background-color:hsl(30, 75%, 60%);text-align:center;"><strong>备注</strong></td></tr><tr><td style="padding:10px;"><strong>机型</strong></td><td>&nbsp;</td><td style="padding:10px;text-align:center;"><strong>实际测试</strong></td><td style="padding:10px;text-align:center;"><strong>S6阶段标准</strong></td><td style="padding:10px;text-align:center;"><strong>是否通过</strong></td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td>&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td>&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td>&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td>&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td></tr></tbody></table></figure><figure class="table" style="float:left;width:100%;"><table class="ck-table-resized"><colgroup><col style="width:11.29%;"><col style="width:4.75%;"><col style="width:6.35%;"><col style="width:7.28%;"><col style="width:7.45%;"><col style="width:3.85%;"><col style="width:59.03%;"></colgroup><tbody><tr><td style="background-color:hsl(30, 75%, 60%);text-align:center;"><span style="font-size:21px;"><strong>流量</strong></span></td><td>&nbsp;</td><td style="background-color:hsl(30, 75%, 60%);text-align:center;" colspan="3"><strong>每10分钟平均流量</strong></td><td style="background-color:hsl(0, 0%, 100%);text-align:center;">&nbsp;</td><td style="background-color:hsl(30, 75%, 60%);text-align:center;"><strong>备注</strong></td></tr><tr><td style="padding:10px;"><strong>机型</strong></td><td>&nbsp;</td><td style="padding:10px;text-align:center;"><strong>实际测试</strong></td><td style="padding:10px;text-align:center;"><strong>S6阶段标准</strong></td><td style="padding:10px;text-align:center;"><strong>是否通过</strong></td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td>&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td>&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td>&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td>&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td></tr></tbody></table></figure><figure class="table" style="float:left;width:100%;"><table class="ck-table-resized"><colgroup><col style="width:11.25%;"><col style="width:4.81%;"><col style="width:6.17%;"><col style="width:7.55%;"><col style="width:7.33%;"><col style="width:4.04%;"><col style="width:58.85%;"></colgroup><tbody><tr><td style="background-color:hsl(30, 75%, 60%);text-align:center;"><span style="font-size:21px;"><strong>流量</strong></span></td><td>&nbsp;</td><td style="background-color:hsl(30, 75%, 60%);text-align:center;" colspan="3"><strong>每10分钟平均流量</strong></td><td style="background-color:hsl(0, 0%, 100%);text-align:center;">&nbsp;</td><td style="background-color:hsl(30, 75%, 60%);text-align:center;"><strong>备注</strong></td></tr><tr><td style="padding:10px;"><strong>机型</strong></td><td>&nbsp;</td><td style="padding:10px;text-align:center;"><strong>实际测试</strong></td><td style="padding:10px;text-align:center;"><strong>S6阶段标准</strong></td><td style="padding:10px;text-align:center;"><strong>是否通过</strong></td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td>&nbsp;</td><td style="padding:10px;text-align:center;"><span style="background-color:rgb(255,255,255);color:rgb(255,0,0);"><strong>/</strong></span></td><td style="padding:10px;text-align:center;"><span style="background-color:rgb(255,255,255);color:rgb(47,117,181);"><strong>无明显发烫体感</strong></span></td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td>&nbsp;</td><td style="padding:10px;text-align:center;"><span style="background-color:rgb(255,255,255);color:rgb(255,0,0);"><strong>/</strong></span></td><td style="padding:10px;text-align:center;"><span style="background-color:rgb(255,255,255);color:rgb(47,117,181);"><strong>无明显发烫体感</strong></span></td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td>&nbsp;</td><td style="padding:10px;text-align:center;"><span style="background-color:rgb(255,255,255);color:rgb(255,0,0);"><strong>/</strong></span></td><td style="padding:10px;text-align:center;"><span style="background-color:rgb(255,255,255);color:rgb(47,117,181);"><strong>无明显发烫体感</strong></span></td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td><td style="padding:10px;text-align:center;">&nbsp;</td></tr><tr><td style="padding:10px;">&nbsp;</td><td>&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td><td style="padding:10px;">&nbsp;</td></tr></tbody></table></figure><figure class="table"><table style="border:1px solid hsl(0, 0%, 100%);"><tbody><tr><td style="border:1px solid hsl(0, 0%, 100%);"><p><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">以上，有劳查阅，如有疑问，请随时联系，谢谢！</span></p><p>胡俊</p><p>深圳第七大道科技有限公司&nbsp;&nbsp;&nbsp;&nbsp;技术中心</p><p>Mob:&nbsp;+86&nbsp;13524778793</p><p><a href="mailto:jun.hu@7road.com"><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">mailto:jun.hu@7road.com</span></a></p><p><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">Add：上海市闵行区合川路3111号2号楼7楼</span></p></td></tr></tbody></table></figure>`,
        test_issue:`<p>Dear all,</p><figure class="table" style="float:left;"><table><tbody><tr><td style="padding:5px;text-align:center;width:200px;"><strong>需求名称</strong></td><td style="padding:5px;text-align:center;width:700px;">&nbsp;</td><td style="padding:5px;text-align:center;width:200px;"><strong>测试时间</strong></td><td style="padding:5px;text-align:center;width:700px;">&nbsp;</td></tr><tr><td style="text-align:center;width:200px;"><strong>版本号</strong></td><td style="padding:5px;text-align:center;width:700px;">&nbsp;</td><td style="padding:5px;text-align:center;width:200px;"><strong>测试阶段</strong></td><td style="padding:5px;text-align:center;width:700px;">&nbsp;</td></tr><tr><td style="text-align:center;width:200px;"><strong>测试类型</strong></td><td style="padding:5px;text-align:center;width:700px;">&nbsp;</td><td style="padding:5px;text-align:center;width:200px;"><strong>测试结果</strong></td><td style="padding:5px;text-align:center;width:700px;">&nbsp;</td></tr><tr><td style="text-align:center;width:200px;"><strong>测试人员</strong></td><td style="padding:5px;text-align:center;width:700px;">&nbsp;</td><td style="padding:5px;text-align:center;width:200px;"><strong>附带文件</strong></td><td style="padding:5px;text-align:center;width:700px;">&nbsp;</td></tr><tr><td style="text-align:center;"><strong>下载地址</strong></td><td>&nbsp;</td><td style="text-align:center;"><strong>包体MD5码</strong></td><td>&nbsp;</td></tr><tr><td style="text-align:center;width:200px;"><strong>测试范围</strong></td><td style="height:100px;padding:20px;width:700px;" colspan="3">&nbsp;</td></tr><tr><td style="text-align:center;width:200px;"><strong>问题汇总</strong></td><td style="height:100px;padding:20px;width:700px;" colspan="3">&nbsp;</td></tr></tbody></table></figure><figure class="table"><table style="border:1px solid hsl(0, 0%, 100%);"><tbody><tr><td style="border:1px solid hsl(0, 0%, 100%);"><p><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">以上，有劳查阅，如有疑问，请随时联系，谢谢！</span></p><p>胡俊</p><p>深圳第七大道科技有限公司&nbsp;&nbsp;&nbsp;&nbsp;技术中心</p><p>Mob:&nbsp;+86&nbsp;13524778793</p><p><a href="mailto:jun.hu@7road.com"><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">mailto:jun.hu@7road.com</span></a></p><p><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">Add：上海市闵行区合川路3111号2号楼7楼</span></p></td></tr></tbody></table></figure>`,
        editorData:`<p>Dear all,</p><figure class="table" style="float:left;"><table><tbody><tr><td style="padding:5px;text-align:center;width:200px;"><strong>需求名称</strong></td><td style="padding:5px;text-align:center;width:700px;">&nbsp;</td><td style="padding:5px;text-align:center;width:200px;"><strong>测试时间</strong></td><td style="padding:5px;text-align:center;width:700px;">&nbsp;</td></tr><tr><td style="text-align:center;width:200px;"><strong>版本号</strong></td><td style="padding:5px;text-align:center;width:700px;">&nbsp;</td><td style="padding:5px;text-align:center;width:200px;"><strong>测试阶段</strong></td><td style="padding:5px;text-align:center;width:700px;">&nbsp;</td></tr><tr><td style="text-align:center;width:200px;"><strong>测试类型</strong></td><td style="padding:5px;text-align:center;width:700px;">&nbsp;</td><td style="padding:5px;text-align:center;width:200px;"><strong>测试结果</strong></td><td style="padding:5px;text-align:center;width:700px;">&nbsp;</td></tr><tr><td style="text-align:center;width:200px;"><strong>测试人员</strong></td><td style="padding:5px;text-align:center;width:700px;">&nbsp;</td><td style="padding:5px;text-align:center;width:200px;"><strong>附带文件</strong></td><td style="padding:5px;text-align:center;width:700px;">&nbsp;</td></tr><tr><td style="text-align:center;"><strong>下载地址</strong></td><td>&nbsp;</td><td style="text-align:center;"><strong>包体MD5码</strong></td><td>&nbsp;</td></tr><tr><td style="text-align:center;width:200px;"><strong>测试范围</strong></td><td style="height:100px;padding:20px;width:700px;" colspan="3">&nbsp;</td></tr><tr><td style="text-align:center;width:200px;"><strong>问题汇总</strong></td><td style="height:100px;padding:20px;width:700px;" colspan="3">&nbsp;</td></tr></tbody></table></figure><figure class="table"><table style="border:1px solid hsl(0, 0%, 100%);"><tbody><tr><td style="border:1px solid hsl(0, 0%, 100%);"><p><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">以上，有劳查阅，如有疑问，请随时联系，谢谢！</span></p><p>胡俊</p><p>深圳第七大道科技有限公司&nbsp;&nbsp;&nbsp;&nbsp;技术中心</p><p>Mob:&nbsp;+86&nbsp;13524778793</p><p><a href="mailto:jun.hu@7road.com"><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">mailto:jun.hu@7road.com</span></a></p><p><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);">Add：上海市闵行区合川路3111号2号楼7楼</span></p></td></tr></tbody></table></figure>`,
        nowdata:``,
