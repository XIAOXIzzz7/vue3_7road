          ...
          <el-card class="box-card" style="flex:0 0 100%">
            ...
            <div style="display:flex;flex-direction: column;float: left;">
                ...
                <div>
                    ...
                    <el-select v-model="data_set.project_value" class="m-2" placeholder="SelectProject" @click="projectchange()">
                        <el-option
                ...
                <div style="margin-left:9px">
                    <el-input style="width: 777px;" v-model="data_set.projectinput1" placeholder="Please input title">
                        <template #prepend>title</template>
                    </el-input>
                </div>
                <div style="margin-left:9px;margin-top:10px;margin-bottom: 20px;">
                    <el-input style="width: 777px;" v-model="data_set.projectinput2" placeholder="Please input text">
