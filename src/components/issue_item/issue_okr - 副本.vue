...
<div class="main">
    ...
    <div style="display:flex ;flex-direction: column;">
        ...
        <div style="display: flex;align-items: center;">
            <h5 style="margin:0px 5px 0px 0px;font-weight:bolder;"  v-if="zgtable_show1">{{time_value1[0]}}年{{time_value1[1]}}月-数据统计</h5>
            <el-popover
                v-if="zgtable_show1"
        ...
        <el-button style="margin-top:4px" v-if="zgtable_show1"  @click="add(1);">添加</el-button>
        <el-button style="margin-top:4px" v-if="zgtable_show1"   @click="delet()">删除</el-button>
        <!-- <el-button style="margin-top:4px" v-if="butshow2"  @click="check()">上传/更新</el-button> -->
        <el-button style="margin-top:4px" v-if="zgtable_show1"  @click="check()">上传/更新</el-button>
    ...
    <el-table  @header-click="statistics" class="animate__animated animate__bounceInLeft" v-if="zgtable_show" :data="tableData" style="width: 100%;margin-top:20px" border 
    ...
    <el-table-column label="打分描述" min-width="40">
     ...
     <div v-show="zgecharts">
        ...
        <el-affix style="float:right;margin-right:100px" :offset="100">
        ...
        <el-dialog v-model="piecharts_dialog" title="OKR数据对比">
            ...
            <el-col  v-for="(i,item) in checkList" :span="12" style="display:flex ;height:400px;width:100%"   >
                ...
                <div style="height:400px;width:100%;" :id="'piechart1'+i">{{'piechart1'+i}}</div>
     ...
     <!-- </div> -->
        ...
        <div style="width:100%;height:100%">
            ...
            <div style="height:400px;width:100%;" id='piechart2'></div>
        </el-dialog>
        </div>
          ...
          shadowColor: 'rgba(0, 0, 0, 0.5)'
            ...
            function piecharts_contrast(){
                ...
                for(var i in get_data.checkList){
                    console.log("piechart1"+get_data.checkList[i]);
                   
                    var chart1 = echarts.getInstanceByDom(document.getElementById("piechart1"+get_data.checkList[i]))
                    if (chart1 == null) { // 如果不存在，就进行初始化
                        chart1 = echarts.init(document.getElementById("piechart1"+get_data.checkList[i]));
                    }
            ...
            function te(){
                setTimeout(() => {
                    var chart2 = echarts.getInstanceByDom(document.getElementById("piechart2"))
                                if (chart2 == null) { // 如果不存在，就进行初始化
                                    chart2 = echarts.init(document.getElementById("piechart2"));
                                }
                chart2.setOption(get_data.options,true)
                }, 300);
            }
            return{
                ...toRefs(get_data),
